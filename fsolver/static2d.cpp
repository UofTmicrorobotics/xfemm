...
//        pctr = 0;
    ...
    for (i = 0; i < NumAirGapElems; i++) {
      ...
      MG[0][1] =
        ...
        Power(
          ci,
          3) * (5 * (-1 + ci * (-5 + 4 * ci)) * K + (-5 + ci * (-19 + 14 * ci)) * Ki)) / 48.;
      MG[0][2] =
        ((-1 + ci) *
        Power(
          ci,
        ...
        (2 + ci *
        (-1 - 9 * ci + 6 *
        Power(ci, 2))) * K + (10 + ci * (1 + 3 * ci * (-7 + 4 * ci))) * Ki)) / 48.;
      MG[0][3] =
        -(Power(
          -1 + ci,
          2) *
        Power(ci, 2) * (5 * (-2 + ci * (-3 + 4 * ci)) * K + (2 + ci * (-3 + 2 * ci)) * Ki)) / 48.;
      MG[0][4] = (Power(-1 + ci, 3) * Power(ci, 3) * (5 * K - Ki)) / 48.;
      MG[0][5] = ((-1 + ci) * Power(ci, 2) * (-1 + co) * Power(co, 2) * (K - 5 * Ki)) / 48.;
      MG[0][6] =
        -((-1 + ci) *
        Power(ci, 2) * co * ((-1 + co * (-5 + 4 * co)) * K + (5 + (19 - 14 * co) * co) * Ki)) / 48.;
      MG[0][7] =
        ((-1 + ci) *
        Power(
          ci,
        ...
        ((2 + co *
        (-1 - 9 * co + 6 *
        Power(co, 2))) * K - (10 + co * (1 + 3 * co * (-7 + 4 * co))) * Ki)) / 48.;
      MG[0][8] =
        -((-1 + ci) *
        Power(
          ci,
          2) * (-1 + co) * ((-2 + co * (-3 + 4 * co)) * K + (-2 + (3 - 2 * co) * co) * Ki)) / 48.;
      ...
      MG[1][1] =
        ...
        Power(
          1 + (5 - 4 * ci) * ci,
          2) * K + (5 + ci * (38 + ci * (49 + 4 * ci * (-29 + 11 * ci)))) * Ki)) / 48.;
      MG[1][2] =
        (-5 * ci * (-1 + 2 * ci) * (-2 + 3 * (-1 + ci) * ci) * (-1 + ci * (-5 + 4 * ci)) * K + ci *
        (10 + ci * (39 - ci * (50 + ci * (85 + 6 * ci * (-23 + 8 * ci))))) * Ki) / 48.;
      MG[1][3] =
        ((-1 + ci) * ci *
      ...
      MG[1][4] =
        -(Power(
          -1 + ci,
          2) *
        Power(ci, 2) * (5 * (-1 + ci * (-5 + 4 * ci)) * K + Ki + ci * (-1 + 2 * ci) * Ki)) / 48.;
      MG[1][5] =
        -(ci * (-1 + co) *
        Power(co, 2) * ((-1 + ci * (-5 + 4 * ci)) * K + (5 + (19 - 14 * ci) * ci) * Ki)) / 48.;
      MG[1][6] =
        (ci * co *
        ((-1 + ci * (-5 + 4 * ci)) * (-1 + co * (-5 + 4 * co)) * K +
        (-5 + ci * (-19 + 14 * ci) - 19 * co + ci * (-77 + 58 * ci) * co + 2 *
        (7 + (29 - 22 * ci) * ci) * Power(co, 2)) * Ki)) / 48.;
      MG[1][7] =
        (-(ci * (-1 + ci * (-5 + 4 * ci)) *
        (2 + co *
        (-1 - 9 * co + 6 *
        Power(
          co,
          2))) * K) + ci *
        (-10 + co * (-1 + 3 * (7 - 4 * co) * co) + ci *
        (-38 + co + 99 *
        Power(
          co,
          2) - 60 *
        Power(co, 3)) + Power(ci, 2) * (28 + 2 * co * (-1 + 3 * co * (-13 + 8 * co)))) * Ki) / 48.;
      MG[1][8] =
        (ci * (-1 + co) *
        ...
        Power(
          ci,
          2) * (4 + 2 * (9 - 10 * co) * co) + ci * (-2 + co * (-21 + 22 * co))) * Ki)) / 48.;
      MG[1][9] =
        -(ci *
        Power(
          -1 + co,
          2) * co * ((-1 + ci * (-5 + 4 * ci)) * K + (-1 + ci - 2 * Power(ci, 2)) * Ki)) / 48.;
      MG[2][2] =
        (5 *
        Power(
          -2 + ci + 9 * Power(ci, 2) - 6 * Power(ci, 3),
          2) * K + (20 + (-1 + ci) * ci * (-4 + 3 * (-1 + ci) * ci * (-25 + 24 * (-1 + ci) * ci))) *
        Ki) / 48.;
      MG[2][3] =
        (-5 *
        (4 +
        Power(
          ci,
          2) * (-33 + ci * (18 + ci * (65 + 6 * ci * (-13 + 4 * ci))))) * K +
        (4 + Power(ci, 2) * (39 - ci * (30 + ci * (115 + 6 * ci * (-25 + 8 * ci))))) * Ki) / 48.;
      MG[2][4] =
        (Power(
          -1 + ci,
          2) * ci *
        ...
        (2 + ci *
        (-1 - 9 * ci + 6 *
        Power(ci, 2))) * K + (-2 + ci * (-5 + 3 * ci * (-5 + 4 * ci))) * Ki)) / 48.;
      MG[2][5] =
        ((-1 + co) *
        Power(
          co,
      ...
      MG[2][6] =
        ...
        Power(
          co,
          2)) + ci *
        (-1 + co - 2 * Power(co, 2)) + 12 * Power(ci, 3) * (-1 + co * (-5 + 4 * co))) * Ki) / 48.;
      MG[2][7] =
        ((2 + ci *
        (-1 - 9 * ci + 6 *
        Power(
        ...
        Power(
          ci,
          2) * (-14 + co * (5 + (55 - 36 * co) * co)) + ci *
        (2 + co * (5 + 3 * (5 - 4 * co) * co)) +
        12 * Power(ci, 3) * (2 + co * (-1 - 9 * co + 6 * Power(co, 2)))) * Ki) / 48.;
      MG[2][8] =
        (-((2 + ci *
        (-1 - 9 * ci + 6 *
        Power(
        ...
        Power(
          co,
          3)) * K) + (-1 + co) *
        (4 + 2 * ci * (5 + 3 * (5 - 4 * ci) * ci) + 3 * (-2 + ci * (3 + (17 - 12 * ci) * ci)) * co +
        2 * (2 + ci * (-7 + 3 * ci * (-11 + 8 * ci))) * Power(co, 2)) * Ki) / 48.;
      MG[2][9] =
        (Power(
          -1 + co,
          2) * co *
        ((2 + ci *
        (-1 - 9 * ci + 6 * Power(ci, 2))) * K + (2 + ci * (5 + 3 * (5 - 4 * ci) * ci)) * Ki)) / 48.;
      MG[3][3] =
        (Power(
          -1 + ci,
          2) *
        ...
        Power(
          2 + (3 - 4 * ci) * ci,
          2) * K + (20 + ci * (36 + ci * (-35 - 60 * ci + 44 * Power(ci, 2)))) * Ki)) / 48.;
      MG[3][4] =
        -(Power(
          -1 + ci,
          3) * ci * (5 * (-2 + ci * (-3 + 4 * ci)) * K + (-10 + ci * (-9 + 14 * ci)) * Ki)) / 48.;
      MG[3][5] =
        -((-1 + ci) * (-1 + co) *
        Power(co, 2) * ((-2 + ci * (-3 + 4 * ci)) * K + (-2 + (3 - 2 * ci) * ci) * Ki)) / 48.;
      MG[3][6] =
        ((-1 + ci) * co *
        ((-2 + ci * (-3 + 4 * ci)) * (-1 + co * (-5 + 4 * co)) * K +
        (2 + ci * (-3 + 2 * ci) - 2 * co + ci * (-21 + 22 * ci) * co + 2 *
        (2 + (9 - 10 * ci) * ci) * Power(co, 2)) * Ki)) / 48.;
      MG[3][7] =
        (-((2 + ci - 7 *
        Power(
          ci,
        ...
        Power(
          co,
          2))) * K) + (-1 + ci) *
        (4 + 2 * co * (5 + 3 * (5 - 4 * co) * co) + ci * (-6 + 3 * co * (3 + (17 - 12 * co) * co)) +
        2 * Power(ci, 2) * (2 + co * (-7 + 3 * co * (-11 + 8 * co)))) * Ki) / 48.;
      MG[3][8] =
        ((-1 + ci) * (-1 + co) *
        ((-2 + ci * (-3 + 4 * ci)) * (-2 + co * (-3 + 4 * co)) * K +
        (-20 + 3 * ci * (1 + 2 * co) * (-6 + 5 * co) + 2 * co * (-9 + 14 * co) +
        Power(ci, 2) * (28 + 30 * co - 44 * Power(co, 2))) * Ki)) / 48.;
      MG[3][9] =
        -((-1 + ci) *
        Power(
          -1 + co,
          2) * co * ((-2 + ci * (-3 + 4 * ci)) * K + (10 + (9 - 14 * ci) * ci) * Ki)) / 48.;
      MG[4][4] = (5 * Power(-1 + ci, 4) * Power(ci, 2) * (K + Ki)) / 48.;
      MG[4][5] = (Power(-1 + ci, 2) * ci * (-1 + co) * Power(co, 2) * (K + Ki)) / 48.;
      MG[4][6] =
        -(Power(
          -1 + ci,
          2) * ci * co * ((-1 + co * (-5 + 4 * co)) * K + (-1 + co - 2 * Power(co, 2)) * Ki)) / 48.;
      MG[4][7] =
        (Power(
          -1 + ci,
          2) * ci *
        ((2 + co *
        (-1 - 9 * co + 6 * Power(co, 2))) * K + (2 + co * (5 + 3 * (5 - 4 * co) * co)) * Ki)) / 48.;
      MG[4][8] =
        -(Power(
          -1 + ci,
          2) * ci * (-1 + co) * ((-2 + co * (-3 + 4 * co)) * K + (10 + (9 - 14 * co) * co) * Ki)) /
        48.;
      ...
      MG[5][6] =
        ...
        Power(
          co,
          3) * (5 * (-1 + co * (-5 + 4 * co)) * K + (-5 + co * (-19 + 14 * co)) * Ki)) / 48.;
      MG[5][7] =
        ((-1 + co) *
        Power(
          co,
      ...
      MG[5][8] =
        -(Power(
          -1 + co,
          2) *
        Power(co, 2) * (5 * (-2 + co * (-3 + 4 * co)) * K + (2 + co * (-3 + 2 * co)) * Ki)) / 48.;
      ...
      MG[6][6] =
        ...
        Power(
          1 + (5 - 4 * co) * co,
          2) * K + (5 + co * (38 + co * (49 + 4 * co * (-29 + 11 * co)))) * Ki)) / 48.;
      MG[6][7] =
        (-5 * co * (-1 + 2 * co) * (-2 + 3 * (-1 + co) * co) * (-1 + co * (-5 + 4 * co)) * K + co *
        (10 + co * (39 - co * (50 + co * (85 + 6 * co * (-23 + 8 * co))))) * Ki) / 48.;
      MG[6][8] =
        ((-1 + co) * co *
      ...
      MG[6][9] =
        -(Power(
          -1 + co,
          2) *
        Power(co, 2) * (5 * (-1 + co * (-5 + 4 * co)) * K + Ki + co * (-1 + 2 * co) * Ki)) / 48.;
      MG[7][7] =
        (5 *
        Power(
          -2 + co + 9 * Power(co, 2) - 6 * Power(co, 3),
          2) * K + (20 + (-1 + co) * co * (-4 + 3 * (-1 + co) * co * (-25 + 24 * (-1 + co) * co))) *
        Ki) / 48.;
      MG[7][8] =
        (-5 *
        (4 +
        Power(
          co,
          2) * (-33 + co * (18 + co * (65 + 6 * co * (-13 + 4 * co))))) * K +
        (4 + Power(co, 2) * (39 - co * (30 + co * (115 + 6 * co * (-25 + 8 * co))))) * Ki) / 48.;
      MG[7][9] =
        (Power(
          -1 + co,
          2) * co *
        ...
        (2 + co *
        (-1 - 9 * co + 6 *
        Power(co, 2))) * K + (-2 + co * (-5 + 3 * co * (-5 + 4 * co))) * Ki)) / 48.;
      MG[8][8] =
        (Power(
          -1 + co,
          2) *
        ...
        Power(
          2 + (3 - 4 * co) * co,
          2) * K + (20 + co * (36 + co * (-35 - 60 * co + 44 * Power(co, 2)))) * Ki)) / 48.;
      MG[8][9] =
        -(Power(
          -1 + co,
          3) * co * (5 * (-2 + co * (-3 + 4 * co)) * K + (-10 + co * (-9 + 14 * co)) * Ki)) / 48.;
...
//            }
      ...
      for (j = 0, k = 1; j < 3; k++, j++) {
        ...
        l[j] = sqrt(
          pow(meshnode[n[k]].x - meshnode[n[j]].x, 2.) +
      ...
      for (j = 0; j < 3; j++) {
        ...
        if (bIncremental == MS_LEGACY_FALSE) {
          El->Jprev += (blockproplist[El->blk].J.Re() + t) / 3.;
        }
      }
...
//                    str = fmatter.str();
        ...
        if (lua_error_code != 0) {
          if (lua_error_code == LUA_ERRRUN) {
            WarnMessage(
              "Lua run Error (LUA_ERRRUN) when evaluating magnetization direction function");
          }
          if (lua_error_code == LUA_ERRMEM) {
            WarnMessage(
              "Lua memory Error (LUA_ERRMEM) when evaluating magnetization direction function");
          }
          if (lua_error_code == LUA_ERRERR) {
            WarnMessage(
              "Lua user error error (LUA_ERRERR) when evaluating magnetization direction function");
          }
          if (lua_error_code == LUA_ERRFILE) {
            WarnMessage(
              "Lua file error (LUA_ERRFILE) when evaluating magnetization direction function");
          }

          SNPRINTF(
            magbuff, sizeof magbuff,
...
//////// Nonlinear Part
      ...
      for (j = 0; j < 3; j++) {
        for (k = 0; k < 3; k++) {
          Me[j][k] +=
            (Mx[j][k] / Re(El->mu2) + My[j][k] / Re(El->mu1) + Mxy[j][k] * Re(El->v12) + Mn[j][k]);
          be[j] += Mn[j][k] * L.V[n[k]];
        }
      }
...
int FSolver::WriteStatic2D(CBigLinProb & L)
{
  ...
  */
  ...
  for (i = 0; i < NumAirGapElems; i++) {
    ...
    fprintf(
      fp, "%i %.17g %.17g %.17g %.17g %.17g %.17g %.17g %i %.17g %.17g\n",
