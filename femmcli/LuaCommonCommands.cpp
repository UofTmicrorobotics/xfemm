...
int femmcli::LuaCommonCommands::luaAddContourPoint(lua_State * L)
{
  ...
  std::shared_ptr<FemmState> femmState = std::dynamic_pointer_cast<FemmState>(
    luaInstance->femmState());
  std::shared_ptr<PostProcessor> pproc = std::dynamic_pointer_cast<PostProcessor>(
    femmState->getPostProcessor());
  if (!pproc) {
...
int femmcli::LuaCommonCommands::luaDeleteBoundaryProperty(lua_State * L)
{
  ...
  doc->lineproplist.erase(
    std::remove_if(
      doc->lineproplist.begin(), doc->lineproplist.end(),
...
int femmcli::LuaCommonCommands::luaDeleteCircuitProperty(lua_State * L)
{
  ...
  doc->circproplist.erase(
    std::remove_if(
      doc->circproplist.begin(), doc->circproplist.end(),
...
int femmcli::LuaCommonCommands::luaDeleteMaterial(lua_State * L)
{
  ...
  doc->blockproplist.erase(
    std::remove_if(
      doc->blockproplist.begin(), doc->blockproplist.end(),
...
int femmcli::LuaCommonCommands::luaDeletePointProperty(lua_State * L)
{
  ...
  doc->nodeproplist.erase(
    std::remove_if(
      doc->nodeproplist.begin(), doc->nodeproplist.end(),
