...
static const char * match(
  lua_State * L, const char * s, const char * p,
  struct Capture * cap);


static const char * matchbalance(
  lua_State * L, const char * s, const char * p,
  struct Capture * cap)
{
  if (*p == 0 || *(p + 1) == 0) {
...
static const char * match_capture(
  lua_State * L, const char * s, int level,
  struct Capture * cap)
{
